                                    ...
                                    @foreach ($products as $item)
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <p class="font-semibold">{{ $item->desc_short }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-xs">
                                                <p class="font-semibold">{{ $item->desc_large }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <p class="font-semibold">{{ $item->price_sell }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <p class="font-semibold">{{ $item->price_purchase }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <p class="font-semibold">{{ $item->stock }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <p class="font-semibold">{{ $item->created_at }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <p class="font-semibold">{{ $item->weight }}</p>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                ...
                                                <form action="{{ route('delete_products') }}" method="post">
                                                    ...
                                                    duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600
                                                    hover:bg-red-700 focus:outline-none focus:shadow-outline-red">Eliminar</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
